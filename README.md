...
1. **Crie Projetos**: Vá para a aba "Projetos" no sidebar e crie seus projetos
2. **Crie Tarefas**: Na aba "Tarefas", adicione tarefas associadas aos projetos
3. **Agende no Calendário**: Arraste tarefas do sidebar para o calendário na data e hora desejadas
4. **Replaneje**: Se precisar mudar, arraste a tarefa agendada para um novo horário
5. **Marque como Concluída**: Clique no ✓ da tarefa para marcar como concluída (informando tempo gasto)
6. **Acompanhe Métricas**: Vá para a aba "Métricas" para ver suas estatísticas
